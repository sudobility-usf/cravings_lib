...
import type { FirebaseIdToken } from '@sudobility/cravings_client';
import { useHistories, useHistoriesTotal } from '@sudobility/cravings_client';
 ...
 * It orchestrates:
 * - **Data fetching** via TanStack Query hooks from `@sudobility/cravings_client`
